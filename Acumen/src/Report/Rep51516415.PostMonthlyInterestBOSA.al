...
Report 51516415 "Post Monthly Interest - BOSA"
{
	UsageCategory = Tasks;
	RDLCLayout = './Layouts/PostMonthlyInterest-BOSA.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Loans Register";"Loans Register")
		{
			...
			begin
				...
				if "Loans Register"."Repayment Method"="Loans Register"."repayment method"::"Straight Line"  then
				AccruedInt:=ROUND(("Loans Register"."Approved Amount"*IntRate/1200),0.05,'>');
