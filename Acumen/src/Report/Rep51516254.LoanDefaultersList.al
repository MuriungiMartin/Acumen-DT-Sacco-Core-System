...
Report 51516254 "Loan Defaulters List"
{
	RDLCLayout = './Layouts/LoanDefaultersList.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem(Loans;test)
		{
			...
			begin
				...
				end else  if HesabuWeeks < Loans.Installments then  begin
				...
				end else  if HesabuWeeks >  ExpIntallment then  begin
