...
{	
	...
	{
		type(ForNav.Report_6_3_0_2259; ForNavReport51516264_v6_3_0_2259){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 51516264 "SMS DEFAULTERS 2"
{
	UsageCategory = ReportsAndAnalysis;
	RDLCLayout = './Layouts/SMSDEFAULTERS2.rdlc'; DefaultLayout = RDLC;
			...
			begin
				...
				// REPEAT
				 ...
				 // IF CONFIRM('Do you want to notify Loanee?',FALSE,TRUE) THEN
				  ...
				  SMSMessages."SMS Message":='Defaulter 2nd Notice: Dear '
						  + "Loans Register"."Client Name"+' kindly note that you have defaulted your loan'+ "Loans Register"."Loan  No."+' by KSHs.'+Format("Loans Register"."Amount in Arrears")+
				...
				//REPEAT
				 ...
				 // IF CONFIRM('Do you want to notify Guarantors?',FALSE,TRUE) THEN
				  ...
				  SMSMessages."Entered By":=UserId;
				  SMSMessages."Sent To Server":=SMSMessages."sent to server"::No;
				  SMSMessages."SMS Message":='Defaulter 2nd Notice: This is to notify you that '
					  + LGuarantor."Loanees  Name"+' has defaulted a loan' +LGuarantors."Loan No"+' you had guaranteed by KSHs.'+Format( LGuarantors."Amont Guaranteed")+
												' at ACUMEN SACCO LTD. ';
				  //IF LoanApp.GET(Lguarantors//."Loan No") THEN
				  SMSMessages."Telephone No":=Cust."Mobile Phone No";
				  SMSMessages.Insert;
	...
	trigger OnPreReport()
	begin
		   ///	MESSAGE (' ...ARE SURE TO SEND NOTIFICATION TO DEFAULTED MEMBERS')
		;ReportsForNavPre;
	end;
	var
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport51516264_v6_3_0_2259;
