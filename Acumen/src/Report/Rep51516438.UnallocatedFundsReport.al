...
Report 51516438 "Unallocated Funds Report"
{
	RDLCLayout = './Layouts/UnallocatedFundsReport.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Member Register";"Member Register")
		{
			...
			column(UnAllocated; "Member Register"."Un-allocated Funds")
			{
			}
