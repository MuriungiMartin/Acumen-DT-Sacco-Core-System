...
Report 51516404 "Member Saving Listing"
{
	RDLCLayout = './Layouts/MemberSavingListing.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Member Register";"Member Register")
		{
			...
			column(Staff_No; "Member Register"."Personal No")
			{
			}
			...
			column(Entrance_Fee; "Member Register"."Registration Fee")
			{
			}
			column(Share_Capital; "Member Register"."Shares Retained")
			{
			}
			column(Welfare; "Member Register"."Welfare Contribution")
			{
			}
			column(Deposits; "Member Register"."Monthly Contribution")
			{
			}
			column(Outstanding_Bal; "Member Register"."Outstanding Balance")
			{
			}
			column(Dividend; "Member Register"."Dividend Amount")
			{
			}
			...
			column(Principle_Balance; "Member Register"."Principal Balance")
			{
			}
			...
			column(COMPPIC; "Member Register".Picture)
			{
			}
			column(NAME1; "Member Register".Name)
			{
			}
