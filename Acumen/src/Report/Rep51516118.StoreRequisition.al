...
{
	RDLCLayout = './Layouts/StoreRequisition.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Store Requistion Header P";"Store Requistion Header P")
		{
			...
			column(Store_Requistion_Header__Required_Date_; "Store Requistion Header P"."Required Date")
			{
			}
			column(Store_Requistion_Header__Shortcut_Dimension_4_Code_; "Store Requistion Header P"."Shortcut Dimension 4 Code")
			{
			}
			column(Store_Requistion_Header_Dim4; "Store Requistion Header P".Dim4)
			{
			}
			column(Store_Requistion_Header__Request_date_; "Store Requistion Header P"."Request date")
			{
			}
			column(Store_Requistion_Header__Shortcut_Dimension_3_Code_; "Store Requistion Header P"."Shortcut Dimension 3 Code")
			{
			}
			column(Store_Requistion_Header_Dim3; "Store Requistion Header P".Dim3)
			{
			}
			column(Store_Requistion_Header__Request_Description_; "Store Requistion Header P"."Request Description")
			{
			}
			column(Store_Requistion_Header__Shortcut_Dimension_2_Code_; "Store Requistion Header P"."Shortcut Dimension 2 Code")
			{
			}
			column(Store_Requistion_Header__Budget_Center_Name_; "Store Requistion Header P"."Budget Center Name")
			{
			}
			column(Store_Requistion_Header__No__; "Store Requistion Header P"."No.")
			{
			}
			column(Store_Requistion_Header__Global_Dimension_1_Code_; "Store Requistion Header P"."Global Dimension 1 Code")
			{
			}
			column(Store_Requistion_Header__Function_Name_; "Store Requistion Header P"."Function Name")
			{
			}
