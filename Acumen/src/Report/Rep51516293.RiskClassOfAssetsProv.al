...
{	
	...
	{
		type(ForNav.Report_6_3_0_2259; ForNavReport51516293_v6_3_0_2259){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 51516293 "Risk Class Of Assets & Prov"
{
	UsageCategory = ReportsAndAnalysis;
	RDLCLayout = './Layouts/RiskClassOfAssets&Prov.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem(Company;"Company Information")
		{
			...
			column(comp_address2; Company."Address 2")
			{
			}
			column(com_address3; Company."Post Code")
			{
			}
			column(comp_address; Company.Address)
			{
			}
			column(AsAt; AsAt)
			{
			...
			begin
				...
				LoansRegister.SetFilter(LoansRegister.Performing,'%1',true);
				LoansRegister.SetFilter(LoansRegister."Outstanding Balance",'>%1',0);
				LoansRegister.SetFilter(LoansRegister.Posted,'%1',true);
				...
				LoansRegister.SetFilter(LoansRegister.Watch,'%1',true);
				LoansRegister.SetFilter(LoansRegister."Outstanding Balance",'>%1',0);
				LoansRegister.SetFilter(LoansRegister.Posted,'%1',true);
				if LoansRegister.FindSet then begin
				  repeat
				...
				LoansRegister.SetFilter(LoansRegister.Doubtful,'%1',true);
				LoansRegister.SetFilter(LoansRegister."Outstanding Balance",'>%1',0);
				LoansRegister.SetFilter(LoansRegister.Posted,'%1',true);
				if LoansRegister.FindSet then begin
				  repeat
				...
				LoansRegister.SetFilter(LoansRegister.Substandard,'%1',true);
				LoansRegister.SetFilter(LoansRegister."Outstanding Balance",'>%1',0);
				LoansRegister.SetFilter(LoansRegister.Posted,'%1',true);
				if LoansRegister.FindSet then begin
				  repeat
				...
				LoansRegister.SetFilter(LoansRegister.Loss,'%1',true);
				LoansRegister.SetFilter(LoansRegister."Outstanding Balance",'>%1',0);
				LoansRegister.SetFilter(LoansRegister.Posted,'%1',true);
				if LoansRegister.FindSet then begin
				  repeat
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport51516293_v6_3_0_2259;
