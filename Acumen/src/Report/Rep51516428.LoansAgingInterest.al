...
Report 51516428 "Loans Aging - Interest"
{
	RDLCLayout = './Layouts/LoansAging-Interest.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem(Loans;"Loans Register")
		{
			...
			begin
				...
				"1MonthC":="1MonthC"+1;
				end else if LastDueDate > CalcDate('-2M',AsAt) then begin
				"2Month":=Loans."Interest Due";
				"2MonthC":="2MonthC"+1;
				end else if LastDueDate > CalcDate('-3M',AsAt) then begin
				"3Month":=Loans."Interest Due";
				"3MonthC":="3MonthC"+1;
				end else if LastDueDate > CalcDate('-4M',AsAt) then begin
