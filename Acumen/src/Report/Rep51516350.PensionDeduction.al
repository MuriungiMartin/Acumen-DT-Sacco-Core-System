...
Report 51516350 "Pension Deduction"
{
	UsageCategory = Lists;
	RDLCLayout = './Layouts/PensionDeduction.rdlc'; DefaultLayout = RDLC;
			...
			begin
				...
				//PAYEE
				 ...
				 //Pension *************************** please redo this ;-) dennis tihihihi
					if (PeriodTrans."Transaction Code"='D021') or (PeriodTrans."Transaction Code"='D021')then
					begin
					   Pension:=Pension+PeriodTrans.Amount;
					   TotPension:=TotPension+PeriodTrans.Amount;
					end;
				 // Voluntary Pension
					if (PeriodTrans."Transaction Code"='D028')   then
					begin
				...
				*/
				  ...
				  // FOSA ADVANCES REPAYMENT DEDUCTION
				  // STAFF HOUSE LOAN
					if (PeriodTrans."Transaction Code"='D020') then
					begin
