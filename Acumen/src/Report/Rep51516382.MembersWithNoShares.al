...
Report 51516382 "Members With No Shares"
{
	RDLCLayout = './Layouts/MembersWithNoShares.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Member Register";"Member Register")
		{
			...
			column(Agency_Code; "Member Register"."Employer Code")
			{
			}
			column(Agency_Name; "Member Register"."Employer Name")
			{
			}
			column(Outstanding_Balance; "Member Register"."Outstanding Balance")
			{
			}
