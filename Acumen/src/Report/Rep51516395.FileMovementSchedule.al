...
Report 51516395 "File Movement Schedule"
{
	RDLCLayout = './Layouts/FileMovementSchedule.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Member Register";"Member Register")
		{
			...
			column(File_Movement_Remarks; "Member Register"."File Movement Remarks")
			{
			}
			column(Current_File_Location; "Member Register"."Current file location")
			{
			}
			column(Move_To; "Member Register"."Move to")
			{
			}
			column(File_Mvt_User_ID; "Member Register"."File MVT User ID")
			{
			}
			column(File_Mvt_Date; "Member Register"."File MVT Date")
			{
			}
			column(File_Mvt_Time; "Member Register"."File MVT Time")
			{
			}
			column(File_Received; "Member Register"."file Received")
			{
			}
			column(File_Previous_Location; "Member Register"."File Previous Location")
			{
			}
			column(User; "Member Register".User)
			{
			}
