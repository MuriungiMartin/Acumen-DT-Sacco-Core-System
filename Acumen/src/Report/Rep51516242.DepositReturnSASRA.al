        ...
        dataitem(Members; Customer)
        {
            ...
            begin
                ...
                if (SchoolFees <> 0) and (SchoolFees <= 50000) then begin
                    ...
                    if (SchoolFees > 50000.01) and (SchoolFees <= 100000) then begin
                        MBAL2 := MBAL2 + SchoolFees;
                        MACOUNT2 := MACOUNT2 + 1;
                    end else
                        if (SchoolFees > 100000.01) and (SchoolFees <= 300000) then begin
                            MBAL3 := MBAL3 + SchoolFees;
                            MACOUNT3 := MACOUNT3 + 1;
                        end else
                            if (SchoolFees > 300000.01) and (SchoolFees <= 1000000) then begin
                                MBAL4 := MBAL4 + SchoolFees;
                                MACOUNT4 := MACOUNT4 + 1;
                            end else
                                if SchoolFees > 1000000 then begin
                ...
                if (Savings <> 0) and (Savings <= 50000) then begin
                    ...
                    if (Savings > 50000.01) and (Savings <= 100000) then begin
                        SBAL2 := SBAL2 + Savings;
                        SACOUNT2 := SACOUNT2 + 1;
                    end else
                        if (Savings > 100000.01) and (Savings <= 300000) then begin
                            SBAL3 := SBAL3 + Savings;
                            SACOUNT3 := SACOUNT3 + 1;
                        end else
                            if (Savings > 300000.01) and (Savings <= 1000000) then begin
                                SBAL4 := SBAL4 + Savings;
                                SACOUNT4 := SACOUNT4 + 1;
                            end else
                                if Savings > 1000000 then begin
                                    SBAL5 := SBAL5 + Savings;
                                    SACOUNT5 := SACOUNT5 + 1;
                                end;
                //*****************
                ...
                if (Asset <> 0) and (Asset <= 50000) then begin
                    ...
                    if (Asset > 50000.01) and (Asset <= 100000) then begin
                        AABAL2 := AABAL2 + Asset;
                        AACOUNT2 := AACOUNT2 + 1;
                    end else
                        if (Asset > 100000.01) and (Asset <= 300000) then begin
                            AABAL3 := AABAL3 + Asset;
                            AACOUNT3 := AACOUNT3 + 1;
                        end else
                            if (Asset > 300000.01) and (Asset <= 1000000) then begin
                                AABAL4 := AABAL4 + Asset;
                                AACOUNT4 := AACOUNT4 + 1;
                            end else
                                if Asset > 1000000 then begin
                                    AABAL5 := AABAL5 + Asset;
                                    AACOUNT5 := AACOUNT5 + 1;
                                end;
                //*************************end
