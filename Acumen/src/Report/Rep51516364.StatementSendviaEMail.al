...
Report 51516364 "Statement Send via E-Mail"
{
	...
	RDLCLayout = './Layouts/StatementSendviaE-Mail.rdlc'; DefaultLayout = RDLC;
		...
		dataitem("Member Register";"Member Register")
		{
			...
			begin
					   ...
					   //to send the mail the report is redirected to print in the PDF printer.
							"Member Register".TestField("E-Mail");
							UserSetup.Get(UserId);
							UserSetup.TestField("E-Mail");
							CUST.Reset;
							CUST.SetRange(CUST."No.","Member Register"."No.");
							CUST.SetFilter(CUST."Date Filter","Member Register".GetFilter("Date Filter"));
							if CUST.Find('-') then
						 ...
						 //Email Address used is the one on UserSetup for Sender and Customer Card Email for Receipient
							SMTP.CreateMessage(COMPANYNAME,UserSetup."E-Mail","Member Register"."E-Mail",Text001,Text000,false);
