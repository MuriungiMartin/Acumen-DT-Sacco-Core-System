...
Report 51516417 "Share Capital Recovery1"
{
	UsageCategory = Tasks;
	RDLCLayout = './Layouts/ShareCapitalRecovery1.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Member Register";"Member Register")
		{
			...
			begin
				...
				DepositsAvailable:=Abs("Member Register"."Current Shares");
				NetPayable:=Abs("Member Register"."Shares Retained");
				ReqAmt:=0;
				GSetup.Get();
