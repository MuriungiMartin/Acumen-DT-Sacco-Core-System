...
{	
	...
	{
		type(ForNav.Report_6_3_0_2259; ForNavReport51516302_v6_3_0_2259){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 51516302 "Loans Repayment ReSchedule"
{
	RDLCLayout = './Layouts/LoansRepaymentReSchedule.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Loans Register";"Loans Register")
		{
			...
			column(LoanrescheduleAmountcj; "Loans Register"."Loan reschedule Amount")
			{
			}
			...
			column(Loanrescheduleinstallament_LoansRegister; "Loans Register"."Loan reschedule installament")
			{
			}
			...
			dataitem("Loan Repayment Schedule";"Loan Repayment Schedule")
			{
				...
				DataItemTableView = sorting("Loan No.","Member No.","Repayment Date") where(Reschedule=filter(true));
				PrintOnlyIfDetail = false;
				...
				column(RepaymentCode; LastFieldNo)
				{
				}
				column(MonthlyInsurance_LoanRepaymentSchedule; "Loan Repayment Schedule"."Monthly Insurance")
				{
				}
				column(ClosedDate_LoanRepaymentSchedule; Format("Loan Repayment Schedule"."Closed Date" ))
				{
				}
				column(InstalmentNo_; "Loan Repayment Schedule"."Instalment No")
				{
				}
			...
			trigger OnAfterGetRecord();
			begin
				//MESSAGE('loan no %1',"Loans Register"."Loan  No.");
				BankDetails:='';
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport51516302_v6_3_0_2259;
