...
Report 51516024 "Cashier Report-ABC"
{
	Caption = 'Bank Acc. - Detail Trial Bal.';
	RDLCLayout = './Layouts/CashierReport-ABC.rdlc'; DefaultLayout = RDLC;
		...
		dataitem("Bank Account";"Bank Account")
		{
			...
			dataitem("Bank Account Ledger Entry";"Bank Account Ledger Entry")
			{
				...
				begin
					...
					else if "Bank Account Ledger Entry"."Bal. Account Type" = "Bank Account Ledger Entry"."bal. account type"::"Bank Account" then
					begin
