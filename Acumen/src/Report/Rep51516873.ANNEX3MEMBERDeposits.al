...
Report 51516873 "ANNEX 3 - MEMBER Deposits"
{
    ...
    RDLCLayout = './Layouts/ANNEX3-MEMBERDeposits.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            {
                DataItemTableView = where("Member No" = filter('NO'));
                column(ReportForNavId_1; 1) { } // Autogenerated by ForNav - Do not delete
                column(InterestEarnedtoDate_FixedDepositPlacement; "Fixed Deposit Placement"."Interest Earned to Date")
                {
                }
                column(AmounttoFix_FixedDepositPlacement; "Fixed Deposit Placement"."Amount to Fix")
                {
                }
                column(ExpectedTaxAfterTermPeriod_FixedDepositPlacement; "Fixed Deposit Placement"."Expected Tax After Term Period")
                {
                }
                column(ExpectedNetAfterTermPeriod_FixedDepositPlacement; "Fixed Deposit Placement"."Expected Net After Term Period")
                {
                }
            }
