...
dotnet // --> Reports ForNAV Autogenerated code - do not delete or modify
{
    ...
    {
        type(ForNav.Report_6_3_0_2259; ForNavReport51516308_v6_3_0_2259) { }
    }
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 51516308 "Member Loan Statement."
{
    RDLCLayout = './Layouts/MemberLoanStatement..rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Member Register"; "Member Register")
        {
            ...
            column(FOSAAccountNo_MemberRegister; "Member Register"."FOSA Account No.")
            {
            }
            ...
            dataitem(Shares; "Cust. Ledger Entry")
            {
                ...
                DataItemTableView = sorting("Transaction Type", "Loan No", "Posting Date") where("Transaction Type" = const("Share Capital"), Reversed = const(false));
            ...
            {
                DataItemLink = "Client Code" = field("No."), "Loan Product Type" = field("Loan Product Filter"), "Date filter" = field("Date Filter"), "Loan  No." = field("Loan No. Filter");
                ...
                dataitem(Interest; "Cust. Ledger Entry")
                {
                    ...
                    trigger OnPreDataItem();
                    begin
                        SetFilter("Posting Date", "Member Register".GetFilter("Member Register"."Date Filter"));
                    end;
    ...
    var
        [WithEvents]
        ReportForNav: DotNet ForNavReport51516308_v6_3_0_2259;
