...
Report 51516243 "Deposit Return-SASRA"
{
    ...
    RDLCLayout = './Layouts/DepositReturn-SASRA.rdlc';
    DefaultLayout = RDLC;
                ...
                if cust.Find('-') then begin
                    ...
                    repeat
                        if SHARES <= 50000 then begin
                            ...
                            if (SHARES > 50001) and (SHARES <= 100000) then begin
                                BAL2 := BAL2 + SHARES;
                                COUNT2 := COUNT2 + 1;
                            end else
                                if (SHARES > 100001) and (SHARES <= 300000) then begin
                                    BAL3 := BAL3 + SHARES;
                                    COUNT3 := COUNT3 + 1;
                                end else
                                    if (SHARES > 300001) and (SHARES <= 1000000) then begin
                                        BAL4 := BAL4 + SHARES;
                                        COUNT4 := COUNT4 + 1;
                                    end else
                    ...
                    repeat
                        ...
                        if Account."Account Type" <> 'FIXED' then begin
                            if Balance <= 50000 then begin
                                ...
                                if (Balance > 50001) and (Balance <= 100000) then begin
                                    ABAL2 := ABAL2 + Balance;
                                    ACOUNT2 := ACOUNT2 + 1;
                                end else
                                    if (Balance > 100001) and (Balance <= 300000) then begin
                                        ABAL3 := ABAL3 + Balance;
                                        ACOUNT3 := ACOUNT3 + 1;
                                    end else
                                        if (Balance > 300001) and (Balance <= 1000000) then begin
                                            ABAL4 := ABAL4 + Balance;
                                            ACOUNT4 := ACOUNT4 + 1;
                                        end else
                                            if Balance > 1000001 then begin
                                                ABAL5 := ABAL5 + Balance;
                                                ACOUNT5 := ACOUNT5 + 1;
                                            end;
                        end;
                    ...
                    repeat
                        ...
                        if Account."Account Type" = 'FIXED' then begin
                            if (Fbalance > 0) and (Fbalance <= 50000) then begin
                                ...
                                if (Fbalance > 50001) and (Fbalance <= 100000) then begin
                                    FABAL2 := FABAL2 + Fbalance;
                                    FACOUNT2 := FACOUNT2 + 1;
                                end else
                                    if (Fbalance > 100001) and (Fbalance <= 300000) then begin
                                        FABAL3 := FABAL3 + Fbalance;
                                        FACOUNT3 := FACOUNT3 + 1;
                                    end else
                                        if (Fbalance > 300001) and (Fbalance <= 1000000) then begin
