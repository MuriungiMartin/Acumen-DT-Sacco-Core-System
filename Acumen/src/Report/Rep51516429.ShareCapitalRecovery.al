...
Report 51516429 "Share Capital Recovery"
{
	RDLCLayout = './Layouts/ShareCapitalRecovery.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem(UnknownTable51516223;Table51516223)
		{
			...
			column(No; Table51516223."No.")
			{
			}
			column(Name; Table51516223.Name)
			{
			}
			column(Shares_Retained; Table51516223."Shares Retained")
			{
			}
			column(Current_Shares; Table51516223."Current Shares")
			{
			}
			...
			begin
				Table51516223.CalcFields(Table51516223."Shares Retained",Table51516223."Current Shares");
				DepositsAvailable:=Abs(Table51516223."Current Shares");
				NetPayable:=Abs(Table51516223."Shares Retained");
				ReqAmt:=0;
				GSetup.Get();
				...
				ReqAmt:=GSetup."Retained Shares" - NetPayable;
					...
					GenJournalLine."Account No.":=Table51516223."No.";
	...
	var
		...
		Jtemplate: Code[30];
		JBatch: Code[30];
		GSetup: Record "HR Leave Planner Lines";
