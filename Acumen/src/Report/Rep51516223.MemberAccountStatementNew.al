...
Report 51516223 "Member Account Statement-New"
{
    ...
    dataset
    {
        dataitem("Member Register"; "Member Register")
        {
            ...
            {
                DataItemLink = "Customer No." = field("No."), "Posting Date" = field("Date Filter");
                DataItemTableView = sorting("Transaction Type", "Loan No", "Posting Date") where("Transaction Type" = const(Holiday), Reversed = filter(false));
