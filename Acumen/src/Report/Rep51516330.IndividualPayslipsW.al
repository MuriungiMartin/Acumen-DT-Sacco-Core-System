...
// Report 51516330 "Individual Payslips W.."
// {
// 	RDLCLayout = './Layouts/IndividualPayslipsW...rdlc'; DefaultLayout = RDLC;

// 	dataset
// 	{
// 		dataitem(UnknownTable51516265;Table51516265)
// 		{
// 			DataItemTableView = sorting(Field1) order(ascending) where(Field51516008=const(0));
...
// 				 dept:='';
// 				 objEmp.Reset;
// 				 objEmp.SetRange(objEmp."No.",Table51516265."Employee Code");
// 				 if objEmp.Find ('-') then
// 				 begin
...
// 				*/
// 				emp1.Reset;
// 				emp1.SetRange(emp1."No.",Table51516265."Employee Code");
