...
Report 51516321 "payroll Bank Payments."
{
	RDLCLayout = './Layouts/payrollBankPayments..rdlc'; DefaultLayout = RDLC;

	dataset
	{
		dataitem(Banks;Banks)
		{
			RequestFilterFields = "Bank Code","Code";
			...
			column(prBank_Structure_Bank_Code; Banks."Bank Code")
			{
			}
			...
			{
				DataItemLink = "Bank Code"=field("Bank Code"),"Branch Code"=field(Code);
				...
				dataitem("prSalary Card";"Payroll Employee.")
				{
					...
					begin
						...
						if objEmp.Find('-') then
						  ...
						  bankStruct.Reset;
						  bankStruct.SetRange(bankStruct."Bank Code",objEmp."Bank Code");
						  bankStruct.SetRange(bankStruct.Code,objEmp."Branch Code");
