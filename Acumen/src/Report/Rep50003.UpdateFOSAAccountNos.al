...
{
	RDLCLayout = './Layouts/UpdateFOSAAccountNos.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Member Register";"Member Register")
		{
			...
			begin
				/*ObjVendor.RESET;
				ObjVendor.SETRANGE(ObjVendor."BOSA Account No","Member Register"."No.");
				//ObjVendor.SETRANGE(ObjVendor."Account Type",'ORDINARY');
				IF ObjVendor.FIND('-') THEN
				  BEGIN
					REPEAT
					  ObjVendor."Personal No.":="Member Register"."Personal No";
					  ObjVendor."ID No.":="Member Register"."ID No.";
					  ObjVendor."Registration Date":="Member Register"."Registration Date";
					  ObjVendor."Date of Birth":="Member Register"."Date of Birth";
					  ObjVendor.MODIFY;
					  UNTIL ObjVendor.NEXT=0;
					IF ObjVendor."Account Type"='ORDINARY' THEN
					  BEGIN
						"Member Register"."FOSA Account No.":=ObjVendor."No.";
						"Member Register".MODIFY;
						END;
					END;
					IF BUFFER.GET(BUFFER."Payroll number") THEN
					"Member Register"."FOSA Account No.":=BUFFER."Payroll number";
					//////////////////*/
				  /*  ObjCust.RESET;
				...
				IF BOSAAcc.FINDSET THEN BEGIN
				  ...
				  END;*/
				BUFFER.Reset;
				BUFFER.SetRange(BUFFER."Payroll number","Member Register"."No.");
