...
Report 51516385 "Member List By Recruiter"
{
	RDLCLayout = './Layouts/MemberListByRecruiter.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Member Register";"Member Register")
		{
			...
			column(Employer_Code; "Member Register"."Employer Code")
			{
			}
			column(Employer_Name; "Member Register"."Employer Name")
			{
			}
			column(Department; "Member Register"."Station/Department")
			{
			}
			column(Recruited_By; "Member Register"."Recruited By")
			{
			}
