...
Report 51516370 "Loans Register"
{
    ...
    dataset
    {
        dataitem("Loans Register"; "Loans Register")
        {
            ...
            RequestFilterFields = "Loan  No.", "Loan Product Type", "Date filter", "Loan Status", "Issued Date", "Batch No.", "Captured By", "Branch Code", "Outstanding Balance", "Loans Category";
            ...
            column(Loans__Oustanding_Interest_; "Loans Register"."Oustanding Interest")
            {
            }
            ...
            column(Loans__Top_Up_Amount_; "Loans Register"."Top Up Amount")
            {
            }
            ...
            column(Loans__Oustanding_Interest__Control1102760041; "Loans Register"."Oustanding Interest")
            {
            }
            column(Loans__Top_Up_Amount__Control1000000001; "Loans Register"."Top Up Amount")
            {
            }
