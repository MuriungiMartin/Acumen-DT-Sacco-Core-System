...
Report 50024 "Payslipxxxxxx"
{
	RDLCLayout = './Layouts/Payslipxxxxxx.rdlc'; DefaultLayout = RDLC;
		...
		dataitem("Payroll Employee.";"Payroll Employee.")
		{
			...
			dataitem("prPeriod Transactions.";"prPeriod Transactions.")
			{
				...
				begin
					...
					//PayrollCalender.SETRANGE(PayrollCalender."Date Opened","Date Issued");
	...
	begin
		 if UserSetup.Get(UserId) then begin
		  //IF NOT UserSetup."Grants Administrator" THEN
