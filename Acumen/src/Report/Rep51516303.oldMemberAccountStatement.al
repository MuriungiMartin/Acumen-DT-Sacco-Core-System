...
{	
	...
	{
		type(ForNav.Report_6_3_0_2259; ForNavReport51516303_v6_3_0_2259){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 51516303 "oldMember Account Statement"
{
	RDLCLayout = './Layouts/oldMemberAccountStatement.rdlc'; DefaultLayout = RDLC;

	dataset
	{
		dataitem(UnknownTable51516223;Table51516223)
		{
			...
			dataitem(Shares;"HR Calendar List")
			{
				DataItemLink = "Customer No."=field("No."),"Posting Date"=field("Date Filter");
				DataItemTableView = sorting("Transaction Type","Loan No","Posting Date") where("Transaction Type"=const("Shares Capital"),Reversed=filter(No));
			...
			dataitem(Deposits;"HR Calendar List")
			{
				DataItemLink = "Customer No."=field("No."),"Posting Date"=field("Date Filter");
				DataItemTableView = sorting("Transaction Type","Loan No","Posting Date") where("Transaction Type"=const("Deposit Contribution"),Reversed=filter(No));
			...
			dataitem(Fosa;"HR Calendar List")
			{
				DataItemLink = "Customer No."=field("No."),"Posting Date"=field("Date Filter");
				DataItemTableView = sorting("Transaction Type","Loan No","Posting Date") where("Transaction Type"=const("FOSA Deposits"),Reversed=filter(No));
			...
			dataitem("Fixed Deposit";"HR Calendar List")
			{
				DataItemLink = "Customer No."=field("No."),"Posting Date"=field("Date Filter");
				DataItemTableView = sorting("Transaction Type","Loan No","Posting Date") where("Transaction Type"=const("Fixed Deposit"),Reversed=filter(No));
			...
			dataitem(Juja;"HR Calendar List")
			{
				DataItemLink = "Customer No."=field("No."),"Posting Date"=field("Date Filter");
				DataItemTableView = sorting("Transaction Type","Loan No","Posting Date") where("Transaction Type"=const(31),Reversed=filter(No));
			...
			dataitem(HousingWater;"HR Calendar List")
			{
				DataItemLink = "Customer No."=field("No."),"Posting Date"=field("Date Filter");
				DataItemTableView = sorting("Transaction Type","Loan No","Posting Date") where("Transaction Type"=const(31),Reversed=filter(No));
			...
			dataitem(Konza;"HR Calendar List")
			{
				DataItemLink = "Customer No."=field("No."),"Posting Date"=field("Date Filter");
				DataItemTableView = sorting("Transaction Type","Loan No","Posting Date") where("Transaction Type"=const(30),Reversed=filter(No));
			...
			dataitem(Lukenya;"HR Calendar List")
			{
				DataItemLink = "Customer No."=field("No."),"Posting Date"=field("Date Filter");
				DataItemTableView = sorting("Transaction Type","Loan No","Posting Date") where("Transaction Type"=const(Insurance),Reversed=filter(No));
			...
			dataitem(HousingMain;"HR Calendar List")
			{
				DataItemLink = "Customer No."=field("No."),"Posting Date"=field("Date Filter");
				DataItemTableView = sorting("Transaction Type","Loan No","Posting Date") where("Transaction Type"=const(34),Reversed=filter(No));
			...
			dataitem(HousingTitle;"HR Calendar List")
			{
				DataItemLink = "Customer No."=field("No."),"Posting Date"=field("Date Filter");
				DataItemTableView = sorting("Transaction Type","Loan No","Posting Date") where("Transaction Type"=filter(33),Reversed=filter(No));
			...
			dataitem(Children;"HR Calendar List")
			{
				DataItemLink = "Customer No."=field("No."),"Posting Date"=field("Date Filter");
				DataItemTableView = sorting("Transaction Type","Loan No","Posting Date") where("Transaction Type"=const(Children),Reversed=filter(No));
			...
			dataitem(Loans;test)
			{
				...
				DataItemTableView = sorting("Loan  No.") where(Posted=const(Yes),"Loan  No."=filter(<>"));
;
				...
				dataitem(loan;"HR Calendar List")
				{
					DataItemLink = "Customer No."=field("Client Code"),"Loan No"=field("Loan  No."),"Posting Date"=field("Date filter");
					DataItemTableView = sorting("Posting Date") where("Transaction Type"=filter(Loan|Repayment),Reversed=filter(No),"Loan No"=filter(<>""),Description=filter(<>"Interest on salary advance"));
				...
				dataitem(Interest;"HR Calendar List")
				{
					DataItemLink = "Customer No."=field("Client Code"),"Loan No"=field("Loan  No."),"Posting Date"=field("Date filter");
					DataItemTableView = sorting("Customer No.","Posting Date","Currency Code") where("Transaction Type"=filter("Interest Due"|"Interest Paid"),Reversed=filter(No),"Loan No"=filter(<>""),Description=filter(<>"Interest on salary advance"));
					...
					trigger OnPreDataItem();
					begin
						SetFilter("Posting Date","Members Register".GetFilter("Members Register"."Date Filter"));
					end;
			...
			dataitem("HR Leave Attachments";"HR Leave Attachments")
			{
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport51516303_v6_3_0_2259;
