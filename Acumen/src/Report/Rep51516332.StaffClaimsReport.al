...
{	
	...
	{
		type(ForNav.Report_6_3_0_2259; ForNavReport51516332_v6_3_0_2259){}   
	}
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 51516332 "Staff Claims Report"
{
	PreviewMode = PrintLayout;
	RDLCLayout = './Layouts/StaffClaimsReport.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Staff Claims Header";"Staff Claims Header")
		{
			...
			dataitem("Vendor Ledger Entry";"Vendor Ledger Entry")
			{
				...
				column(DocNo; "Vendor Ledger Entry".DocNo)
				{
				}
			...
			dataitem("Staff Claim Lines";"Staff Claim Lines")
			{
				...
				column(NoOfDays_StaffClaimLines; "Staff Claim Lines"."No. Of Days")
				{
				}
	...
	var 
		[WithEvents]
		ReportForNav : DotNet ForNavReport51516332_v6_3_0_2259;
