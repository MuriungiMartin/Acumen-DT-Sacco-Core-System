...
{
    RDLCLayout = './Layouts/ValidateCheckoff-Distributed.rdlc';
    DefaultLayout = RDLC;
                    ...
                    if "Checkoff Lines-Distributed"."Special Code" = 'BEN' then
                        ...
                        if "Checkoff Lines-Distributed"."Special Code" = '229' then
                            ...
                            if "Checkoff Lines-Distributed"."Special Code" = '337' then
                                ...
                                if "Checkoff Lines-Distributed"."Special Code" = '110' then
