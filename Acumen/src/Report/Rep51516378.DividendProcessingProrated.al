...
Report 51516378 "Dividend Processing-Prorated"
{
    UsageCategory = Tasks;
        ...
        if ObjLoans.FindSet then begin
            repeat
                ...
                if VarAmountinArrears > 0 then begin
                    ...
                    LineNo := LineNo + 10000;
                    SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::Dividend,
                    GenJournalLine."account type"::Member, MemberNo, PostingDate, VarAmountRecovered, 'BOSA', ObjLoans."Loan  No.",
                    ...
                    GenJournalLine."account type"::Member, MemberNo, PostingDate, VarAmountRecovered * -1, 'BOSA', ObjLoans."Loan  No.",
    ...
    begin
        ...
        if ObjMember.FindSet then begin
            ...
            if ObjMember."Current Shares" < ObjGensetup."Div Capitalization Min_Indiv" then begin
                ...
                LineNo := LineNo + 10000;
                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::Dividend,
                GenJournalLine."account type"::Member, MemberNo, PostingDate, VarActualCapitalizedAmount, 'BOSA', '',
                ...
                GenJournalLine."account type"::Member, MemberNo, PostingDate, VarActualCapitalizedAmount * -1, 'BOSA', '',
                'Dividend Capitalized- ' + Format(PostingDate), '');
