...
Report 51516345 "Third Rule Report W.."
{
	RDLCLayout = './Layouts/ThirdRuleReportW...rdlc'; DefaultLayout = RDLC;

	dataset
	{
		dataitem(UnknownTable51516265;Table51516265)
		{
			RequestFilterFields = Field17,Field1;
			...
			column(prSalary_Card__prSalary_Card___Employee_Code_; Table51516265."Employee Code")
			{
			}
	...
	begin
		...
		PeriodFilter:=Table51516265.GetFilter("Period Filter");
		if PeriodFilter='' then Error('You must specify the period filter');
		SelectedPeriod:=Table51516265.GetRangeMin("Period Filter");
		objPeriod.Reset;
