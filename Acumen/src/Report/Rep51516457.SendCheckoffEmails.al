...
{
    RDLCLayout = './Layouts/SendCheckoffEmails.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            begin
                AmountToDeduct := 0;
                AmountToDeduct := FnExistsInCheckOff(Customer."No.");
                if AmountToDeduct > 0 then begin
                    //MESSAGE('Total is %1',FnExistsInCheckOff("Members Register"."No."));
                    FnGenerateCheckoffSlips(Customer."No.", Customer."No." + '_' + CheckoffNo + '.pdf');
                end;
            end;
    ...
    begin
        ...
        if ObjCheckoffDetails.Find('-') then begin
            repeat
