...
dotnet // --> Reports ForNAV Autogenerated code - do not delete or modify
{
    ...
    {
        type(ForNav.Report_6_3_0_2259; ForNavReport51516291_v6_3_0_2259) { }
    }
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 51516291 "Loan balance  Statement"
{
    RDLCLayout = './Layouts/LoanbalanceStatement.rdlc';
    DefaultLayout = RDLC;
        ...
        dataitem(Customer; Customer)
        {
            ...
            dataitem(Loans; "Loans Register")
            {
                ...
                dataitem(loan; "Cust. Ledger Entry")
                {
                    ...
                    DataItemTableView = sorting("Posting Date") where("Transaction Type" = filter(Loan | "Loan Repayment" | "Interest Paid" | "Interest Due" | "Loan Insurance Charged" | "Loan Insurance Paid"), Reversed = const(false));
    ...
    var
        [WithEvents]
        ReportForNav: DotNet ForNavReport51516291_v6_3_0_2259;
