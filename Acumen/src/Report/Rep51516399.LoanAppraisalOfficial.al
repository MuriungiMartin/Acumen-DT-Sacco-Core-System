...
Report 51516399 "Loan Appraisal-Official"
{
    RDLCLayout = './Layouts/LoanAppraisal-Official.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Loans Register"; "Loans Register")
        {
            ...
            column(insurance; LoanInsurance)
            {
            }
    ...
    begin
        ...
        if LoanType.Get("Loans Register"."Loan Product Type") then begin
            ...
            LoanApp.Reset;
            LoanApp.SetRange(LoanApp."Client Code", "Loans Register"."Client Code");
            LoanApp.SetRange("Loan Product Type", 'FOSALOAN');
            LoanApp.SetRange(LoanApp.Posted, true);
            if LoanApp.Find('-') then begin
                LoanApp.CalcFields(LoanApp."Outstanding Balance");
                if LoanApp."Outstanding Balance" > 0 then begin
    ...
    begin
        ...
        if LoanType.Get("Loans Register"."Loan Product Type") then begin
            ...
            Upfronts := LoanInsurance + EmergencyUpfront + ProcessingFee + LoanFormFee + LAppraisalFee + LoanTransferFee + BridgeLevy + ShareBoostComm + ExciseDutyShareBoostComm + "Loans Register"."Boosted Amount" +
