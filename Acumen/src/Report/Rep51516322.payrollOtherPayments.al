...
Report 51516322 "payroll Other Payments."
{
	RDLCLayout = './Layouts/payrollOtherPayments..rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Payroll Employee.";"Payroll Employee.")
		{
			...
			begin
				  ...
				  bankStruct.Reset;
				  bankStruct.SetRange(bankStruct."Bank Code","Bank Code");
				  bankStruct.SetRange(bankStruct.Code,"Branch Code");
