...
{
    RDLCLayout = './Layouts/FORM3-DEPOSITSReturn.rdlc';
    DefaultLayout = RDLC;
            ...
            begin
                ...
                if Members."Group Account No" <> '' then
                    ...
                    if (Group <> 0) and (Group <= 50000) then begin
                        ...
                        if (Group > 50000.01) and (Group <= 100000) then begin
                            SBAL2 := SBAL2 + Group;
                            SACOUNT2 := SACOUNT2 + 1;
                        end else
                            if (Group > 100000.01) and (Group <= 300000) then begin
                                SBAL3 := SBAL3 + Group;
                                SACOUNT3 := SACOUNT3 + 1;
                            end else
                                if (Group > 300000.01) and (Group <= 1000000) then begin
                                    SBAL4 := SBAL4 + Group;
                                    SACOUNT4 := SACOUNT4 + 1;
                                end else
                                    if Group > 1000000 then begin
                                        SBAL5 := SBAL5 + Group;
                                        SACOUNT5 := SACOUNT5 + 1;
                                    end;
                //*****************
