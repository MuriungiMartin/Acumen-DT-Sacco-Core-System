...
{
	RDLCLayout = './Layouts/AccountClosureSlip.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Member Register";"Member Register")
		{
			...
			column(Members__ID_No__; "Member Register"."ID No.")
			{
			}
			...
			column(Members__Outstanding_Balance_; "Member Register"."Outstanding Balance")
			{
			}
			...
			column(Current_Shares___1; "Member Register"."Current Shares")
			{
			}
			column(SharesRetained_MembersRegister; "Member Register"."Shares Retained"-2000)
			{
			}
			column(Insurance_Fund___1; "Member Register"."Insurance Fund")
			{
			}
			column(RiskFund_MembersRegister; "Member Register"."Risk Fund")
			{
			}
			column(Members__Accrued_Interest_; "Member Register"."Accrued Interest")
			{
			}
			...
			column(Members__Insurance_Fund_; "Member Register"."Insurance Fund")
			{
			}
			column(NetPayable; NetPayable)
			{
			}
			column(Members__Current_Investment_Total_; "Member Register"."Current Investment Total")
			{
			}
			column(Members__Dividend_Amount_; "Member Register"."Dividend Amount")
			{
			}
			...
			column(Members__FOSA_Outstanding_Balance_; "Member Register"."FOSA Outstanding Balance")
			{
			}
