...
Report 51516446 "Loan Balance -Report Summary"
{
	RDLCLayout = './Layouts/LoanBalance-ReportSummary.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem(Loans2;"Loans Register")
		{
			...
			dataitem("<Loans>";"Loans Register")
			{
				...
				column(Top_Up_Amount; Lonning."Top Up Amount")
				{
				}
			...
			begin
				...
				NETHk:=ROUND(NETHk+("Approved Amount"-"Top Up Amount"-("Top Up Amount"*0.1)))
				end else
				...
				NETHADV:=ROUND(NETHADV+("Approved Amount"-(("Top Up Amount"*0.1)+"Top Up Amount")))
				end else
				...
				NETHOKOA:=ROUND(NETHOKOA+("Approved Amount"-(("Top Up Amount"*0.1)+"Top Up Amount")))
				end else
				...
				NETHSFADV:=ROUND(NETHSFADV+("Approved Amount"-(("Top Up Amount"*0.1)+"Top Up Amount")),1,'=')
				end else
				...
				NETHSFDEF:=ROUND(NETHSFDEF+("Approved Amount"-(("Top Up Amount"*0.1)+"Top Up Amount")),1,'=')
				end else
				if "Loan Product Type"='HSFSPECIAL' then begin
				CalcFields("Top Up Amount");
				AmountSpF:=AmountSpF+"Requested Amount";
				ApprovedSPF:=ApprovedSPF+"Approved Amount";
				NETSPF:=NETSPF+("Approved Amount"-"Top Up Amount"-("Top Up Amount"*0.1))
				end;
				until Loans2.Next=0;
			end;
