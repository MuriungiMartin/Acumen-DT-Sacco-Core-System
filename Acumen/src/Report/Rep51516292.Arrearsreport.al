...
dotnet // --> Reports ForNAV Autogenerated code - do not delete or modify
{
    ...
    {
        type(ForNav.Report_6_3_0_2259; ForNavReport51516292_v6_3_0_2259) { }
    }
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 51516292 "Arrears report"
{
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = './Layouts/Arrearsreport.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = where("Outstanding Balance" = filter(> 0), "Loans Category-SASRA" = filter(Substandard | Doubtful | Loss));
            ...
            dataitem(Customer; Customer)
            {
                ...
                column(EMail_MemberRegister; Customer."E-Mail")
                {
                }
                column(PostCode_MemberRegister; Customer."Post Code")
                {
                }
                column(Address_MemberRegister; Customer.Address)
                {
                }
            }
    ...
    var
        [WithEvents]
        ReportForNav: DotNet ForNavReport51516292_v6_3_0_2259;
