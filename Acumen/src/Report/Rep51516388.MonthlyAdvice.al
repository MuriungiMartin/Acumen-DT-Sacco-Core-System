...
Report 51516388 "Monthly Advice"
{
	RDLCLayout = './Layouts/MonthlyAdvice.rdlc'; DefaultLayout = RDLC;
	...
	dataset
	{
		dataitem("Member Register";"Member Register")
		{
			...
			column(Risk_Fund; "Member Register"."Risk Fund")
			{
			}
			column(Shares_Deduction; "Member Register"."Monthly Contribution")
			{
			}
