...
dotnet // --> Reports ForNAV Autogenerated code - do not delete or modify
{
    ...
    {
        type(ForNav.Report_6_3_0_2259; ForNavReport51516621_v6_3_0_2259) { }
    }
} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 51516621 "Loan Appraisal Draft COLL"
{
    RDLCLayout = './Layouts/LoanAppraisalDraftCOLL.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Loans Register"; "Loans Register")
        {
            ...
            column(VarTotalLoansnotSecuredbyCollateral; VarTotalLoansnotSecuredbyCollateral)
            {
            }
            ...
            dataitem("Loans Guarantee Details"; "Loans Guarantee Details")
            {
                ...
                column(garantoramount; garantoramount)
                {
                }
            ...
            begin
                ...
                FnGetShareBoosting();
                Recomm := ROUND(FnReccommendAmount("Loans Register"."Requested Amount", DepX, TotalGuaranteed, Psalary));//ROUND(Psalary,0.1,'<')),100,'<');
                ...
                "Loans Register"."Requested Amount", DepX, TotalGuaranteed, Psalary, Recomm);//ROUND(Psalary,0.1,'<'),Recomm);
    ...
    var
        ...
        ADVFEE: Decimal;
        colatvall: Decimal;
        LoanCollateralDetailstb: Record "Loan Collateral Details";
        garantoramount: Decimal;
    ...
    begin
        ...
        GenSetUp.Get();
        Multiplier := 0;
        if ("Loans Register".Savings < 200000) then begin
            DEpMultiplier := GenSetUp."Deposit Multiplier <200K" * ("Loans Register"."Boosted Amount" + Cshares);
            Multiplier := GenSetUp."Deposit Multiplier <200K";
        end else begin
            DEpMultiplier := GenSetUp."Deposits Multiplier" * ("Loans Register"."Boosted Amount" + Cshares);
            Multiplier := GenSetUp."Deposits Multiplier";
        end;
        if LoanType.Get("Loans Register"."Loan Product Type") then begin
        ...
        DepX := (DEpMultiplier + "Loans Register"."Boosted Amount") - LOANBALANCE + BRIGEDAMOUNT;
    ...
    begin
        ...
        if LoanG.Find('-') then begin
            ...
            until LoanG.Next = 0;
            garantoramount := GShares;
        end;
        //**** collateral + garantors
        LoanCollateralDetailstb.Reset;
        LoanCollateralDetailstb.SetRange("Loan No", "Loans Register"."Loan  No.");
        if LoanCollateralDetailstb.Find('-') then begin
            repeat
                colatvall := colatvall + LoanCollateralDetailstb."Guarantee Value";
            until LoanCollateralDetailstb.Next = 0;
        end;
        GShares := GShares + colatvall;
        /////***
    ...
    begin
        ...
        if LoanType.Get("Loans Register"."Loan Product Type") then begin
            ...
            LoanInsurance := ROUND((((5.03 * "Loans Register".Installments + 3.03) * "Loans Register"."Approved Amount" / 6000) * 0.8), 0.05, '>');
            //"Loan Insurance":=LoanInsurance;
            ProcessingFee := SFactory.FnGetChargeFee("Loans Register"."Loan Product Type", "Loans Register"."Approved Amount", '');
            ...
            LAppraisalFee := SFactory.FnGetChargeFee("Loans Register"."Loan Product Type", "Loans Register"."Approved Amount", 'LAPF');
            ...
            Upfronts := LoanInsurance + EmergencyUpfront + ProcessingFee + LoanFormFee + ADVFEE + LAppraisalFee + LoanTransferFee + BridgeLevy + ShareBoostComm + ExciseDutyShareBoostComm + "Loans Register"."Boosted Amount" +
    ...
    begin
        ...
        if RecommendedAmount > QSalary then begin
            ...
            if RecommendedAmount > QGuarantors then
                RecommendedAmount := QGuarantors + colatvall;
        end;
        ...
        if LoanType.Get("Loans Register"."Loan Product Type") then begin
            ...
            if ((LoanType."Appraise Guarantors") and (LoanType."Appraise Salary")) then begin
                if RecommendedAmount > QSalary then
                    Message('here issalary %1', QSalary);
                RecommendedAmount := QSalary;
                if RecommendedAmount > QGuarantors then
                    RecommendedAmount := QGuarantors + colatvall;
    ...
    var
        [WithEvents]
        ReportForNav: DotNet ForNavReport51516621_v6_3_0_2259;
