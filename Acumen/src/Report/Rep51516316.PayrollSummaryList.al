...
Report 51516316 "PayrollSummary List."
{
	RDLCLayout = './Layouts/PayrollSummaryList..rdlc'; DefaultLayout = RDLC;
	...
	begin
		...
		'E0001':LeaveAllowance:=ObjTransactions.Amount;//Leave Allowance
		'E0002':MedicalAllowance:=ObjTransactions.Amount;//Medical Allowance
		'E0003':HouseAllowance:=ObjTransactions.Amount;//House Allowance
		'E0004':CarAllowance:=ObjTransactions.Amount;//Car Allowance
		'E0005':EntertainmentAllowance:=ObjTransactions.Amount;//Entertainment Allowance
		...
		*/
		...
		'E0020':ActingAllowance:=ObjTransactions.Amount;//Acting Allowance
		//'E0021'::=ObjTransactions.Amount;//Salary Underpayment
		'E0022':RiskAllowance:=ObjTransactions.Amount;//Risk Allowance
		'E0023':CommuterAllowance:=ObjTransactions.Amount;//Commuter Allowance
		end;
	...
	begin
		  case ObjTransactions."Transaction Code" of
			'BPAY':	   BasicPay:=ObjTransactions.Amount;
			'GPAY':	   Grosspay:=ObjTransactions.Amount;
			'PNSR':	   StaffPensionContribution:=ObjTransactions.Amount;
			'PSNR':	   PersonalRelief:=ObjTransactions.Amount;
			'OTHER-DED':  OtherDeductions:=ObjTransactions.Amount;
			'TOT-DED':	TotalDeductions:=ObjTransactions.Amount;
			'NPAY':	   NetPay:=ObjTransactions.Amount;
		  end;
	end;
	...
	begin
		  case ObjTransactions."Group Text" of
			'STATUTORIES': StatutoryDeductionsTotal:=StatutoryDeductionsTotal+ObjTransactions.Amount;
		  end;
	end;
