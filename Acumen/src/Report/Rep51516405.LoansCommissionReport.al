...
Report 51516405 "Loans Commission Report"
{
	RDLCLayout = './Layouts/LoansCommissionReport.rdlc'; DefaultLayout = RDLC;

	dataset
	{
		dataitem("Loans Register";"Loans Register")
		{
			DataItemTableView = sorting("Loan  No.") where(Source=const(" "),"Outstanding Balance"=filter(<>0),"Loan Product Type"=filter(<>'INTARR'),"Approved Amount"=filter(<>0),"Top Up Amount"=filter(<>0));
			...
			column(Top_Up_Amount; "Loans Register"."Top Up Amount")
			{
			}
			column(Top_Up_Commission; "Loans Register"."Topup Commission")
			{
			}
