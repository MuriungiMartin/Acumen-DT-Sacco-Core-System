...
Report 51516383 "New Member List"
{
	RDLCLayout = './Layouts/NewMemberList.rdlc'; DefaultLayout = RDLC;

	dataset
	{
		dataitem("Member Register";"Member Register")
		{
			DataItemTableView = sorting("No.") where(Status=filter(New),Name=filter(<>''));
			...
			column(Application_No; "Member Register"."Application No.")
			{
			}
			...
			column(Phone_No; "Member Register"."Phone No.")
			{
			}
			column(Agency_Name; "Member Register"."Employer Name")
			{
			}
			column(Personal_No; "Member Register"."Personal No")
			{
			}
			column(ID_No; "Member Register"."ID No.")
			{
			}
			...
			begin
				CShares:=CShares+"Member Register"."Current Shares";
			end;
