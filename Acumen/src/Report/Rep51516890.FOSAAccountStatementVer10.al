...
Report 51516890 "FOSA Account Statement Ver.1.0"
{
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            column(Company_Code; Vendor."Employer Code")
            {
            }
            ...
            column(Vendor__Uncleared_Cheques_; Vendor."Uncleared Cheques")
            {
            }
            column(DataItem1102760019; ((StartBalanceLCY + StartBalAdjLCY + "Vendor Ledger Entry"."Amount (LCY)" + Correction + ApplicationRounding) * -1) -Vendor."Uncleared Cheques" - MinBal)
            {
            }
            ...
            dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
            {
                ...
                dataitem("Detailed Vendor Ledg. Entry"; "Detailed Vendor Ledg. Entry")
                {
                    ...
                    DataItemTableView = sorting("Vendor Ledger Entry No.", "Entry Type", "Posting Date") where("Entry Type" = const("Correction of Remaining Amount"), Reversed = const(false));
                ...
                {
                    DataItemLink = "Vendor Ledger Entry No." = field("Entry No.");
                    DataItemTableView = sorting("Vendor Ledger Entry No.", "Entry Type", "Posting Date") where("Entry Type" = const("Appln. Rounding"), Reversed = const(false));
            ...
            begin
                //***********************************************************************************************chagres
                if StatementChargeFee = true then begin
                    VendorApp.Reset;
                    VendorApp.SetRange(VendorApp."No.", Vendor."No.");
                    if VendorApp.Find('-') then begin
                        ...
                        ChargeAmount := 0;
                        Charges.Reset;
                        Charges.SetRange(Charges.Code, '20');
                        if Charges.Find('-') then begin
                            ChargeAmount := Charges."Charge Amount" * PageNo;
                        end;
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                field("Statement Charge"; StatementChargeFee)
                {
                    ApplicationArea = Basic;
                }
                field("Number of Pages"; PageNo)
                {
                    ApplicationArea = Basic;
                }
