                    ...
                    begin
                        ...
                        if Confirm('Are you sure you want to transfer schedule?', false) = true then begin
                            ...
                            if "Deposit Debit Options" = "deposit debit options"::"Partial Refund" then begin
                                ...
                                //GenJournalLine.DELETEALL;
                                if BSched."Charge Transfer Fee" = true then begin
                                    LineNo := LineNo + 10000;
                                    GenJournalLine.Init;
                                    ...
                                    GenJournalLine.Description := BSched."Transaction Description";
                                    GenJournalLine."Bal. Account Type" := GenJournalLine."bal. account type"::"G/L Account";
                                    GenJournalLine."Bal. Account No." := ObjGensetup."Checkoff Interest Account";
                                    GenJournalLine.Validate(GenJournalLine."Currency Code");
                                    GenJournalLine."Shortcut Dimension 1 Code" := 'BOSA';
                                    GenJournalLine."Shortcut Dimension 2 Code" := 'NAIROBI';
                                    //IF TransType = 'Withdrawal' THEN
                                    GenJournalLine.Amount := ObjGensetup."Contactual Shares (%)" + 200;
                                    //ELSE
                            ...
                            //  GenJnlLine.VALIDATE(GenJnlLine."Journal Template Name");
                              ...
                              GenJnlLine."External Document No.":='DIVTRNSF';
                            ...
                            if BSched.Find('-') then begin
                                repeat
                                    ...
                                    if BSched."Charge Transfer Fee" = true then begin
                                        ...
                                        GenJournalLine.Description := BSched."Transaction Description";
                                        GenJournalLine."Bal. Account Type" := GenJournalLine."bal. account type"::"G/L Account";
                                        GenJournalLine."Bal. Account No." := '10215';
                                        GenJournalLine.Validate(GenJournalLine."Currency Code");
                                        GenJournalLine."Shortcut Dimension 1 Code" := 'BOSA';
                                        GenJournalLine."Shortcut Dimension 2 Code" := 'NAIROBI';
                                        //IF TransType = 'Withdrawal' THEN
