...
Report 51516334 "prPayrollJournalTransfer.."
{
    ProcessingOnly = true;
    ...
    dataset
    {
        ...
        {
            // RequestFilterFields = Field17,Field1,Field323,Field29;
    ...
    var
        ...
        LineNumber: Integer;
        //  "Salary Card": Record UnknownRecord51516265;
        TaxableAmount: Decimal;
        // PostingGroup: Record UnknownRecord51516283;
        GlobalDim1: Code[10];
        GlobalDim2: Code[10];
        // TransCode: Record UnknownRecord51516332;
        PostingDate: Date;
        ...
        // EmployerDed: Record UnknownRecord51516327;
        PeriodDate: Date;
